...
Snakemake is another very popular tool, and similar lesson can be found in Carpentry [HPC
Python](https://hpc-carpentry.github.io/hpc-python), for several reasons:
...
The rest of these lessons aim to teach you how to use Nextflow by example.
